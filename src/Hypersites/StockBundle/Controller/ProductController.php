...
class ProductController extends Controller
{
     ...
     *
     * @Route("/", name="stock_product_create")
     * @Method("POST")
    ...
    private function createCreateForm(Product $entity)
    {
        $form = $this->createForm(new ProductType(), $entity, array(
            'action' => $this->generateUrl('stock_product_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/new", name="stock_product_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="stock_product_show")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new ProductType(), $entity, array(
            'action' => $this->generateUrl('stock_product_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="stock_product_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('stock_product_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="stock_product_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('stock_product_delete', array('id' => $id)))
            ->setMethod('DELETE')
